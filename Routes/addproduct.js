...
router.put("/update-product/:seller_id/:product_id", async (req, res) => {
  try {
      const existingProduct = await Product.findOne({
      product_id: req.params.product_id,
      "sellerdetails.seller_id": req.params.seller_id
    });
    ...
    const result = await Product.updateOne(
      { product_id: req.params.product_id, "sellerdetails.seller_id": req.params.seller_id },
      { $set: updateData }
    );
